...
SELECT ProductCode, Description, UnitPrice FROM Products WHERE (ProductCode = @ProductCode)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT ProductCode, Description, UnitPrice\r\n FROM dbo.Products\r\nWHERE (ProductCod" +
                "e = @ProductCode)";
        ...
        public virtual int FillBy(MMABooksDataSet.ProductsDataTable dataTable, string ProductCode) {
